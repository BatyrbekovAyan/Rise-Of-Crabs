...
public class SquareRoot2 : MonoBehaviour, ICreatureBody
{
    ...
    {
        number = 2;
        totalLife = 8 + Creatures.levelRow / 2;
        currentLife = totalLife;
        speed = 0.2f * Mathf.Sqrt(50 + 0.1f * Levels.level);
        endPointPresition = Random.Range(0.001f, 0.01f);
        horizontalDistanceMin = 1f;
        horizontalDistanceMax = 2f;
        verticalDistanceMin = 0.4f;
        verticalDistanceMax = 0.8f;
        ...
        transform.parent.GetComponent<Creature>().totalLife = 1 + Creatures.levelRow / 16;
    ...
    public IEnumerator Shot()
    {
        ...
        transform.parent.GetComponent<Creature>().GivePoints(1);
