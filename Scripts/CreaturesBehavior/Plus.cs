...
public class Plus : MonoBehaviour, ICreatureBody
{
    ...
    public void Start()
    {
        number = (int)Mathf.Pow(2f, Random.Range(0, 3 - (Levels.level - 1) % Creatures.sameLevelsNumber + Mathf.FloorToInt(Mathf.Sqrt(Creatures.levelRow - 1)) - Mathf.FloorToInt((Levels.level - 1) / 48)));
        ...
        totalLife = 15 + Creatures.levelRow / 2;
        ...
        transform.parent.GetComponent<Creature>().totalLife = 4 + Creatures.levelRow / 16;
    ...
    public IEnumerator Shot()
    {
        ...
        transform.parent.GetComponent<Creature>().GivePoints(10);
