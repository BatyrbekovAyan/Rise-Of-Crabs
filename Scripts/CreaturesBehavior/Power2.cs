...
public class Power2 : MonoBehaviour, ICreatureBody
{
    ...
    {
        number = 2;
        totalLife = 50 + Creatures.levelRow / 2;
        currentLife = totalLife;
        speed = 0.4f * Mathf.Sqrt(50 + 0.1f * Levels.level);
        endPointPresition = Random.Range(0.01f, 0.1f);
        horizontalDistanceMin = 0.4f;
        horizontalDistanceMax = 0.6f;
        verticalDistanceMin = 0.05f;
        verticalDistanceMax = 0.2f;
        leftLimit = Creatures.leftWallInnerEdge;
        rightLimit = Creatures.righWallInnerEdge;
        newPosition = transform.position;
        SignAndNumberText = transform.GetChild(0);
        SignAndNumberText.GetComponent<TextMeshProUGUI>().text = sign + "";
        Slider = transform.GetChild(1).GetComponent<Slider>();
        Slider.maxValue = totalLife;
        Slider.value = totalLife;
        Rune = transform.GetChild(2);

        transform.parent.GetComponent<Creature>().totalLife = 6 + Creatures.levelRow / 16;
    ...
    public IEnumerator Hooked()
    {
        ...
        {
            GameManager.OperationMadeTextStatic.text = sign + "";
    ...
    public IEnumerator Shot()
    {
        ...
        transform.parent.GetComponent<Creature>().GivePoints(40);
