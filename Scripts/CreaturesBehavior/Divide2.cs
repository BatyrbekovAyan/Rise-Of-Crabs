...
public class Divide2 : MonoBehaviour, ICreatureBody
{
    ...
    public void Start()
    {
        number = (int)Mathf.Pow(2f, Random.Range(1, (Levels.level - 1) % Creatures.sameLevelsNumber - 1 + Mathf.FloorToInt(Mathf.Sqrt(Creatures.levelRow - 1)) - Mathf.FloorToInt((Levels.level - 1) / 48)));
        ...
        totalLife = 10 + Creatures.levelRow / 2;
        currentLife = totalLife;
        speed = 0.3f * Mathf.Sqrt(50 + 0.1f * Levels.level);
        endPointPresition = Random.Range(0.01f, 0.1f);
        horizontalDistanceMin = 0.2f;
        horizontalDistanceMax = 0.8f;
        ...
        transform.parent.GetComponent<Creature>().totalLife = 2 + Creatures.levelRow / 16;
    ...
    public IEnumerator Shot()
    {
        ...
        transform.parent.GetComponent<Creature>().GivePoints(3);
